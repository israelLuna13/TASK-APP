...
export default function ProfileForm({ data }:ProfileFormProps) {
    ...
    //mutation to update name and email
    const {mutate} = useMutation({
        ...
        onSuccess:(data)=>{
            toast.success(data)
            queryClient.invalidateQueries({queryKey:['user']}) //we bring the new data, we execute the function to get at the user in session
        }
    })
    ...
    return (
        <>
            <div className="mx-auto max-w-3xl g">
                ...
                <p className="text-2xl font-light text-gray-500 mt-5">Update your information</p>
